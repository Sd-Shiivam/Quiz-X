...
data= {"meta":{"title":"Computer Quiz","author":"shivam singh","length": 3},"questions":{"Q1":{"question":"How many Bits are in a Byte?","choices":["1","2","3","4"]},"Q2":{"question":"Where many","choices":["1","2","three","4"]},"Q3":{"question":"How much","choices":["one","2","3","4"]}}}
...
class GUI:
    def __init__(self, root):
        ...
        self.choiceOne = Button(mainarea, text="Choice 1",relief="groove", bg="blue", fg="#306bff", width=35,height=10, highlightcolor="red", font=('Roboto', '12'))
        self.choiceOne.grid(row=2,column=0,sticky="W",padx=20, pady=30)

        self.choiceTwo = Button(mainarea, text="Choice 2",relief="groove", bg="blue", fg="#306bff", width=35,height=10, highlightcolor="red", font=('Roboto', '12'))
        self.choiceTwo.grid(row=2,column=1,sticky="W",padx=20, pady=30)

        self.choiceThree = Button(mainarea, text="Choice 3",relief="groove", bg="blue", fg="#306bff", width=35,height=10, highlightcolor="red", font=('Roboto', '12'))
        self.choiceThree.grid(row=4,column=0,sticky="W",padx=70, pady=30)

        self.choiceFour = Button(mainarea, text="Choice 4",relief="groove", bg="blue", fg="#306bff", width=35,height=10, highlightcolor="red", font=('Roboto', '12'))
        self.choiceFour.grid(row=4,column=1,sticky="W",padx=25, pady=30)
