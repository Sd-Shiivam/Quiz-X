...
def fileExplore():
    filename = filedialog.askopenfilename(initialdir = os.getcwd(),title = "Select ShivamQuiz Quiz file",filetypes = (("json files","*.json"),("all files","*.*")))
    print (filename)
    loadQuiz(filename)
    
global Quiz
data = {"meta":{"title":"Computer Quiz","author":"Shivam singh","length":3},"questions":{"Q1":{"question":"How many Bits are in a Byte?","choices":["8 Bits","2 Bits","6 Bits","4 Bits"],"answer":1},"Q2":{"question":"Where many","choices":["1","2","three","4"],"answer":4},"Q3":{"question":"How much","choices":["one","2","3","4"],"answer":3}}}
Quiz= Questions(**data)
