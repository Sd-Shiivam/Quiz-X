...
class QuizGUI:
    ...
    def createQuiz(self):
        ...
        self.title = Label(self.mainarea, text="ShivamQuiz Quiz Creator", bg="#46178f", fg="white",font=('Helvetica Neue',24,"bold"),wraplength=700,pady=5)
    ...
    def selectQuiz(self,other):
        ...
        try:
            self.filename=str(self.browseQuiz.get(self.browseQuiz.curselection())+".SHIVAM")
        except:
            pass
        
        self.meta= (json.load(open(str(self.browseQuiz.get(self.browseQuiz.curselection())+".SHIVAM"))))
    ...
    def fileExplore(self):
        ...
        self.filename = filedialog.askopenfilename(initialdir = os.getcwd(),title = "Select ShivamQuiz Quiz file",filetypes = [("ShivamQuiz Quiz Files","*.SHIVAM")])
...
def init():   
    ...
    print("\tShivamQuiz Started!\t\tMade By Shivam Singh\n"+"-"*55)
    root.mainloop()
